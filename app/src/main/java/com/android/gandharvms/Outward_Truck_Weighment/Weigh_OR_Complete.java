...
public class Weigh_OR_Complete extends AppCompatActivity {

    int scrollX = 0;
    List<Common_Outward_model> clubList = new ArrayList<>();
    RecyclerView rvClub;
    HorizontalScrollView headerscroll;
    Adapter_Weigh_Complete adapterWeighComplete;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weigh_or_complete);
        ...
        imgBtnExportToExcel = findViewById(R.id.btn_orinweighExportToExcel);
                ...
                new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        ...
                        if ((isFromDate || !isFromDate)) {
                            ...
                            Toasty.warning(Weigh_OR_Complete.this, "Invalid date selection", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                year, month, day);
    ...
    private void exportToExcel(List<Common_Outward_model> datalist) {
        try {
            ...
            headerRow.createCell(7).setCellValue("LOADED QTY");
            ...
            for (int i = 0; i < datalist.size(); i++) {
                ...
                dataRow.createCell(5).setCellValue(dataItem.getCustomerName());
                ...
                dataRow.createCell(8).setCellValue(dataItem.getTareWeight());
    ...
    {
        rvClub = findViewById(R.id.recyclerviewitin_weigh_hcogrid_truckin);
        headerscroll = findViewById(R.id.itin_Weigh_coheaderscroll_truckwe);
    }
    private void setUpRecyclerView()
    {
        adapterWeighComplete  = new Adapter_Weigh_Complete(clubList);
        FixedGridLayoutManager manager = new FixedGridLayoutManager();
        manager.setTotalColumnCount(1);
        rvClub.setLayoutManager(manager);
        rvClub.setAdapter(adapterWeighComplete);
    ...
    public void fetchDataFromApiforweigh(String FromDate,String Todate,String vehicleType,char nextprocess, char inOut) {
        ...
        call.enqueue(new Callback<List<Common_Outward_model>>() {
            ...
            public void onFailure(Call<List<Common_Outward_model>> call, Throwable t) {
                ...
                Toasty.error(Weigh_OR_Complete.this,"failed..!", Toast.LENGTH_SHORT).show();
            }
        });
    }
}