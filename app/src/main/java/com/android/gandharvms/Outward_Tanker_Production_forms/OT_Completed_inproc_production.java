...
public class OT_Completed_inproc_production extends AppCompatActivity {
    int scrollX = 0;
    List<Common_Outward_model> clubList = new ArrayList<>();
    RecyclerView rvClub;
    HorizontalScrollView headerscroll;
    Adapter_OT_completed_inproc_prodcuction adapterOtCompletedInprocProdcuction;
                ...
                new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        ...
                        if ((isFromDate || !isFromDate)) {
                            ...
                            Toasty.warning(OT_Completed_inproc_production.this, "Invalid date selection", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                year, month, day);
...
//                }
    ...
    {
        rvClub = findViewById(R.id.recyclerviewitin_inprcproduction_cogrid_tankerkin);
        headerscroll = findViewById(R.id.itin_inprocprocustion_coheaderscroll_tankerin);
    }

    private void setUpRecyclerView()
    {
        adapterOtCompletedInprocProdcuction  = new Adapter_OT_completed_inproc_prodcuction(clubList);
    ...
    public void fetchDataFromApiforweigh(String FromDate,String Todate,String vehicleType,char nextprocess, char inOut) {
        ...
        call.enqueue(new Callback<List<Common_Outward_model>>() {
            ...
            public void onFailure(Call<List<Common_Outward_model>> call, Throwable t) {
                ...
                Toasty.error(OT_Completed_inproc_production.this,"failed..!", Toast.LENGTH_SHORT).show();
