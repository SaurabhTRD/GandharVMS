...
public class livevehdatafor_logistic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_livevehdatafor_logistic);
    ...
    {
        rvClub = findViewById(R.id.orlivevehlogrecyclerview);
        headerscroll = findViewById(R.id.orlivevehlogheaderscroll);
    }
