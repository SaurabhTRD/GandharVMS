...
public class OT_Completed_Billing extends AppCompatActivity {

    int scrollX = 0;
    List<Common_Outward_model> clubList = new ArrayList<>();
    RecyclerView rvClub;
    HorizontalScrollView headerscroll;
    Adapter_OT_Completed_Billing adapterOtCompletedBilling;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ot_completed_billing);
        ...
        imgBtnExportToExcel = findViewById(R.id.btn_otinbillingExportToExcel);
                ...
                new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        ...
                        if ((isFromDate || !isFromDate)) {
                            ...
                            Toasty.warning(OT_Completed_Billing.this, "Invalid date selection", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                year, month, day);
    ...
    private void exportToExcel(List<Common_Outward_model> datalist) {
        try {
            Sheet sheet = hssfWorkBook.createSheet("OutwardTankerBilling");
            // Create header row
            ...
            headerRow.createCell(8).setCellValue("PRODUCT NAME");
            ...
            for (int i = 0; i < datalist.size(); i++) {
                ...
                dataRow.createCell(8).setCellValue(dataItem.getProductName());
    ...
    private void saveWorkbookToFile(HSSFWorkbook hssfWorkBook) {
        try {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.R) {
                ...
                int counter = 1;
                String fileName = "Outward Tanker Billing Data_" + dateTimeSuffix + ".xls";
                File outputfile = new File(storageVolume.getDirectory().getPath() + "/Download/" + fileName);
                while (outputfile.exists()) {
                    counter++;
                    fileName = "Outward Tanker Billing Data_" + dateTimeSuffix + "_" + counter + ".xls";
    ...
    {
        rvClub = findViewById(R.id.recyclerviewitin_billing_cogrid_tankerkin);
        headerscroll = findViewById(R.id.itin_billing_coheaderscroll_tankerin);
    }

    private void setUpRecyclerView()
    {
        adapterOtCompletedBilling  = new Adapter_OT_Completed_Billing(clubList);
        FixedGridLayoutManager manager = new FixedGridLayoutManager();
        manager.setTotalColumnCount(1);
        rvClub.setLayoutManager(manager);
        rvClub.setAdapter(adapterOtCompletedBilling);
    ...
    public void fetchDataFromApiforweigh(String FromDate,String Todate,String vehicleType,char nextprocess, char inOut) {
        ...
        call.enqueue(new Callback<List<Common_Outward_model>>() {
            ...
            public void onFailure(Call<List<Common_Outward_model>> call, Throwable t) {
                ...
                Toasty.error(OT_Completed_Billing.this,"failed..!", Toast.LENGTH_SHORT).show();
            }
        });
    }
}