...
public class Model_industrial {
    ...
    public String getIlInTime() {
        return ilInTime;
    }

    public void setIlInTime(String ilInTime) {
        this.ilInTime = ilInTime;
    }

    public String getIlOutTime() {
        return ilOutTime;
    }

    public void setIlOutTime(String ilOutTime) {
    ...
    public String getSplInTime() {
        return splInTime;
    }

    public void setSplInTime(String splInTime) {
        this.splInTime = splInTime;
    }

    public String getSplOutTime() {
        return splOutTime;
    }

    public void setSplOutTime(String splOutTime) {
