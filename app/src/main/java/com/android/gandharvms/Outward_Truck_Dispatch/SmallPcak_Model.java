...
public class SmallPcak_Model {
    ...
    public SmallPcak_Model(int outwardId, String splInTime, String splOutTime, int splpackof7ltrqty, int splpackof7_5ltrqty, int splpackof8_5ltrqty, int splpackof10ltrqty, int splpackof11ltrqty, int splpackof12ltrqty, int splpackof13ltrqty, int splpackof15ltrqty, int splpackof18ltrqty, int splpackof20ltrqty, int splpackof26ltrqty, int splpackof50ltrqty, int splpackof210ltrqty, int splpackofboxbuxketltrqty, String spltotqty, String splweight, String splsign, String splRemark,String CreatedBy, String vehicleNumber,String serialNumber, String updatedBy, char nextProcess, char i_O, String vehicleType,String purposeProcess) {
        OutwardId = outwardId;
