...
public class Response_Outward_Security_Fetching {
    ...
    private String TransportLRcopy;
    ...
    private char CurrentProcess;
    private String Factory_In;
    private String Factory_Out;
    private String SerialNumber;
    private String VehicleNumber;
    private String TransportName;
    private String MobileNumber;
    private String CapacityVehicle;
    ...
    private int HowMuchQuantityFilled;
