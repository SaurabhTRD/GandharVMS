...
public class CommonResponseModelForAllDepartment {
    public int InwardId;
    ...
    public String SampleReceivingTime;
    public String SampleSubmittedTime;
    ...
    public int _40KV;
    public int _100KV;
    public int AnLinePoint;
    public int FlashPoint;
    public String AdditionalTest;
    public String SampleTest;
    public String SignOf;
