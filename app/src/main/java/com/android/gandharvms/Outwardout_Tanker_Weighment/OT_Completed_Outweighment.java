...
public class OT_Completed_Outweighment extends AppCompatActivity {

    int scrollX = 0;
    List<Common_Outward_model> clubList = new ArrayList<>();
    RecyclerView rvClub;
    HorizontalScrollView headerscroll;
    Adapter_OT_completed_outweighment adapterOtCompletedOutweighment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ot_completed_outweighment);
        ...
        imgBtnExportToExcel = findViewById(R.id.btn_tankeroutweighmentExportToExcel);
                ...
                new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        ...
                        if ((isFromDate || !isFromDate)) {
                            ...
                            Toasty.warning(OT_Completed_Outweighment.this, "Invalid date selection", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                year, month, day);
    ...
    private void exportToExcel(List<Common_Outward_model> datalist) {
        try {
            ...
            headerRow.createCell(5).setCellValue("DENSITY");
            headerRow.createCell(6).setCellValue("TARE WEIGHT");
            headerRow.createCell(7).setCellValue("NET WEIGHT");
            ...
            for (int i = 0; i < datalist.size(); i++) {
                ...
                dataRow.createCell(6).setCellValue(dataItem.getTareWeight());
                dataRow.createCell(7).setCellValue(dataItem.getNetWeight());
    ...
    {
        rvClub = findViewById(R.id.recyclerviewitin_outweighment_cogrid_tankerkin);
        headerscroll = findViewById(R.id.itin_outweighment_coheaderscroll_tankerin);
    }

    private void setUpRecyclerView()
    {
        adapterOtCompletedOutweighment  = new Adapter_OT_completed_outweighment(clubList);
        FixedGridLayoutManager manager = new FixedGridLayoutManager();
        manager.setTotalColumnCount(1);
        rvClub.setLayoutManager(manager);
        rvClub.setAdapter(adapterOtCompletedOutweighment);
    ...
    public void fetchDataFromApiforweigh(String FromDate,String Todate,String vehicleType,char nextprocess, char inOut) {
        ...
        call.enqueue(new Callback<List<Common_Outward_model>>() {
            ...
            public void onFailure(Call<List<Common_Outward_model>> call, Throwable t) {
                ...
                Toasty.error(OT_Completed_Outweighment.this,"failed..!", Toast.LENGTH_SHORT).show();
            }
        });
    }
}