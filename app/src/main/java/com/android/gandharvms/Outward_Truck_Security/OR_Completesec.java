...
public class OR_Completesec extends AppCompatActivity {

    int scrollX = 0;
    List<Common_Outward_model> clubList = new ArrayList<>();
    RecyclerView rvClub;
    HorizontalScrollView headerscroll;
    Adapter_OR_Completesec adapterOrCompletesec;
...
//        EdgeToEdge.enable();
                ...
                new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        ...
                        if ((isFromDate || !isFromDate)) {
                            ...
                            Toasty.warning(OR_Completesec.this, "Invalid date selection", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                year, month, day);
    ...
    private void exportToExcel(List<Common_Outward_model> datalist) {
        try {
            ...
            headerRow.createCell(8).setCellValue("REMARK");
            headerRow.createCell(9).setCellValue("VEHICLE_PERMIT");
            headerRow.createCell(10).setCellValue("LR COPY");
            ...
            for (int i = 0; i < datalist.size(); i++) {
                ...
                dataRow.createCell(8).setCellValue(dataItem.getRemark());
                dataRow.createCell(9).setCellValue(dataItem.getVehiclePermit());
                dataRow.createCell(10).setCellValue(dataItem.getTransportLRcopy());
    ...
    private void saveWorkbookToFile(HSSFWorkbook hssfWorkBook) {
        try {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.R) {
                ...
                int counter = 1;
                String fileName = "Outward Truck Security Data_" + dateTimeSuffix + ".xls";
    ...
    {
        rvClub = findViewById(R.id.recyclerviewitinweighcogrid_truckin);
        headerscroll = findViewById(R.id.itinweighcoheaderscroll_truckwe);
    }

    private void setUpRecyclerView()
    {
        adapterOrCompletesec  = new Adapter_OR_Completesec(clubList);
        FixedGridLayoutManager manager = new FixedGridLayoutManager();
        manager.setTotalColumnCount(1);
        rvClub.setLayoutManager(manager);
        rvClub.setAdapter(adapterOrCompletesec);
    ...
    public void fetchDataFromApiforweigh(String FromDate,String Todate,String vehicleType,char nextprocess, char inOut) {
        ...
        call.enqueue(new Callback<List<Common_Outward_model>>() {
            ...
            public void onFailure(Call<List<Common_Outward_model>> call, Throwable t) {
                ...
                Toasty.error(OR_Completesec.this,"failed..!", Toast.LENGTH_SHORT).show();
            }
        });
    }
