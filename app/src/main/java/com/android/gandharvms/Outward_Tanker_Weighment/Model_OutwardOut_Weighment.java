...
public class Model_OutwardOut_Weighment {
    ...
    public Model_OutwardOut_Weighment(int outwardId, String outDriverImage, String outVehicleImage, String outInTime, String netWeight, String grossWeight, String numberofPack, String outWRemark, String sealNumber, String updatedBy, char nextProcess, char i_O, String vehicleType) {
        OutwardId = outwardId;
