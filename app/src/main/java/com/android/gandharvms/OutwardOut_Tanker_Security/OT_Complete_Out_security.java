...
public class OT_Complete_Out_security extends AppCompatActivity {

    int scrollX = 0;
    List<Common_Outward_model> clubList = new ArrayList<>();
    RecyclerView rvClub;
    HorizontalScrollView headerscroll;
    Adapter_OT_complete_OutSecurity adapterOtCompleteOutSecurity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ot_complete_out_security);
    ...
    {
        rvClub = findViewById(R.id.recycleroutsecurity_tankerout);
        headerscroll = findViewById(R.id.itincoheaderscroll_tankeroutsec);
    }

    private void setUpRecyclerView()
    {
        adapterOtCompleteOutSecurity  = new Adapter_OT_complete_OutSecurity(clubList);
        FixedGridLayoutManager manager = new FixedGridLayoutManager();
        manager.setTotalColumnCount(1);
        rvClub.setLayoutManager(manager);
        rvClub.setAdapter(adapterOtCompleteOutSecurity);
    ...
    public void fetchDataFromApiforweigh(String FromDate,String Todate,String vehicleType,char nextprocess, char inOut) {
        ...
        call.enqueue(new Callback<List<Common_Outward_model>>() {
            ...
            public void onFailure(Call<List<Common_Outward_model>> call, Throwable t) {
                ...
                Toasty.error(OT_Complete_Out_security.this,"failed..!", Toast.LENGTH_SHORT).show();
            }
        });
    }
}