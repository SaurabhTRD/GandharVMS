...
public class or_departmentscompletedexport_trackdata extends NotificationCommonfunctioncls {
    ...
    or_departmentscompletedexport_trackdataadapter gridadaptercomp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_or_departmentscompletedexport_trackdata);
        btnFromDate = findViewById(R.id.OrdeptcomptrackexportbtnfromDate);
        btnToDate = findViewById(R.id.OrdeptcomptrackexportbtntoDate);
        totrec=findViewById(R.id.Ordeptcomptrackexporttotrecord);
        ...
        imgBtnExportToExcel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (clubList != null && !clubList.isEmpty()) {
                    new AlertDialog.Builder(or_departmentscompletedexport_trackdata.this)
    ...
    {
        rvClub = findViewById(R.id.Ordeptcomptrackexportrecy);
        headerscroll = findViewById(R.id.Ordeptcomptrackexporths);
    }

    private void getDatabydateselection() {
        ProgressDialog loadingDialog = new ProgressDialog(or_departmentscompletedexport_trackdata.this);
    ...
    {
        gridadaptercomp  = new or_departmentscompletedexport_trackdataadapter(clubList);
    ...
    public void fetchDataFromApi(String fromdate, String todate,String vehicleType,ProgressDialog loadingDialog) {
        ...
        call.enqueue(new Callback<List<Common_Outward_model>>() {
                ...
                try {
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        if (response.body().size() > 0 && data != null && !data.isEmpty()) {
                            ...
                            Toasty.info(or_departmentscompletedexport_trackdata.this, "No records found", Toast.LENGTH_SHORT).show();
                            // You can also clear RecyclerView if needed
                        }
                    } else {
                        Toasty.error(or_departmentscompletedexport_trackdata.this, "Server error: " + response.code(), Toast.LENGTH_SHORT).show();
                    }
                }catch (Exception e) {
                    e.printStackTrace();
                    Toasty.error(or_departmentscompletedexport_trackdata.this, "Something went wrong while processing response", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<List<Common_Outward_model>> call, Throwable t) {
                ...
                Toasty.error(or_departmentscompletedexport_trackdata.this,"failed..!", Toast.LENGTH_SHORT).show();
            }
        });
    }
                ...
                new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        ...
                        if ((isFromDate || !isFromDate)) {
                            ...
                            Toasty.warning(or_departmentscompletedexport_trackdata.this, "Invalid date selection", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                year, month, day);
    ...
    private void exportToExcel(List<Common_Outward_model> datalist) {
        try {
            Sheet sheet = hssfWorkBook.createSheet("OutwardTruckDepartmentTrackStatus");
            // Create header row
            ...
            headerRow.createCell(6).setCellValue("Log_INTIME");
            headerRow.createCell(7).setCellValue("Log_OUTTIME");
            headerRow.createCell(8).setCellValue("Log_WTTIME");
            ...
            headerRow.createCell(12).setCellValue("IL_INTIME");
            headerRow.createCell(13).setCellValue("IL_OUTTIME");
            headerRow.createCell(14).setCellValue("IL_WTIME");
            headerRow.createCell(15).setCellValue("SPL_INTIME");
            headerRow.createCell(16).setCellValue("SPL_OUTTIME");
            headerRow.createCell(17).setCellValue("SPL_WTTIME");
            ...
            for (int i = 0; i < datalist.size(); i++) {
                ...
                String logintimelength = club.getLogInTime()!=null ? club.getLogInTime() : "";
                String logouttimelength = club.getLogOutTime()!=null ? club.getLogOutTime(): "";
                String logwaittimelength = club.getLogWTTime()!=null ? club.getLogWTTime(): "";
                ...
                String ilintimelength = club.getIlInTime()!=null ? club.getIlInTime() : "";
                String ilouttimelength = club.getIlOutTime()!=null ? club.getIlOutTime(): "";
                String ilwaittimelength = club.getIndustrialWTTime()!=null ? club.getIndustrialWTTime(): "";

                String splintimelength = club.getSplInTime()!=null ? club.getSplInTime() : "";
                String splouttimelength = club.getSplOutTime()!=null ? club.getSplOutTime(): "";
                String splwaittimelength = club.getSmallpackWTTime()!=null ? club.getSmallpackWTTime(): "";
                ...
                String outdataentryintimelength = club.getOutDEProductionIntime()!=null ? club.getOutDEProductionIntime() : "";
                String outdataentryouttimelength = club.getOutDEProductinOutTime()!=null ? club.getOutDEProductinOutTime(): "";
                String outdataentrywaittimelength = club.getOutDEProWTTime()!=null ? club.getOutDEProWTTime(): "";
                ...
                dataRow.createCell(6).setCellValue(logintimelength);
                dataRow.createCell(7).setCellValue(logouttimelength);
                dataRow.createCell(8).setCellValue(logwaittimelength);
                ...
                dataRow.createCell(12).setCellValue(ilintimelength);
                dataRow.createCell(13).setCellValue(ilouttimelength);
                dataRow.createCell(14).setCellValue(ilwaittimelength);
                dataRow.createCell(15).setCellValue(splintimelength);
                dataRow.createCell(16).setCellValue(splouttimelength);
                dataRow.createCell(17).setCellValue(splwaittimelength);
    ...
    private void saveWorkbookToDownloads(HSSFWorkbook hssfWorkBook) {
        try {
            ...
            String fileName = "OutwardTruck_DepartmentTrackData_" + dateTimeSuffix + ".xls";
